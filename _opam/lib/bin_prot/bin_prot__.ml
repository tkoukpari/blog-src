...
(** @canonical Bin_prot.Read_intf *)
module Read_intf = Bin_prot__Read_intf
...
(** @canonical Bin_prot.Size_intf *)
module Size_intf = Bin_prot__Size_intf
...
(** @canonical Bin_prot.Type_class_intf *)
module Type_class_intf = Bin_prot__Type_class_intf
...
(** @canonical Bin_prot.Write_intf *)
module Write_intf = Bin_prot__Write_intf

module Bin_prot__ = struct end
